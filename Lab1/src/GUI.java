...
class MainFrame extends JFrame
{
	...
	private JButton creatTextButton;							// to do
	...
	public MainFrame()
	{
		...
		textChooseButton = new JButton("���ı��ļ�");
		creatGraphButton = new JButton("��������ͼ");
		queryWordButton = new JButton("��ѯ�ŽӴ�");
		creatTextButton = new JButton("�������ı�");
		queryPathButton = new JButton("��ѯ���·��");
		ranWalkButton = new JButton("�������");
		// set frame
		setTitle("������");
		...
		{ 
		    public void mouseClicked(java.awt.event.MouseEvent e) 
		    {
			    ...
			    { 
			        ...
			        public String getDescription() { return "Unicode�ı��ļ�(*.txt)"; } 
			    }); 
			    ...
			    { 
		            ...
		            {
			            	JOptionPane.showMessageDialog(null, "�ı���û�е��ʻ��߷�Unicode����");
			        		creatGraphButton.setEnabled(false);
			        		queryWordButton.setEnabled(false);
			        		creatTextButton.setEnabled(false);
			        		queryPathButton.setEnabled(false);
	...
	private void setCreatGraphButton()
	{
		...
		{ 
		    public void mouseClicked(java.awt.event.MouseEvent e) 
		    {
				...
				JOptionPane.showMessageDialog(null, "ͼ���ѱ������������Ŀ¼graph.png");
		    }
		});
	}
	...
	private void setQueryWordButton()
	{
		queryWordButton.addMouseListener(new java.awt.event.MouseAdapter() 
		{
			public void mouseClicked(java.awt.event.MouseEvent e)
			{
				JFrame jfQueryWord = new JFrame("��ѯ�ŽӴ�");
	...
	private void setCreatTextButton()
	{
		creatTextButton.addMouseListener(new java.awt.event.MouseAdapter() 
		{
			public void mouseClicked(java.awt.event.MouseEvent e)
			{
				JFrame jfQueryWord = new JFrame("�������ı�");
				JPanel bigPanel = new JPanel();
				...
				jfQueryWord.setResizable(false);
				JTextField jtQueryWord1 = new JTextField("��������ʲô");
	...
	private void setqueryPathButton()
	{
		queryPathButton.addMouseListener(new java.awt.event.MouseAdapter() 
		{
			public void mouseClicked(java.awt.event.MouseEvent e)
			{
				JFrame jfQueryWord = new JFrame("��ѯ���·��");
